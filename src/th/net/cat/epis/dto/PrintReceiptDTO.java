...
public class PrintReceiptDTO implements Serializable{
	...
	private ReceiptOffline receiptOffline;
	...
	private SettlePaymentDTO settlePaymentDTO = new SettlePaymentDTO();
	...
	public ReceiptOffline getReceiptOffline() {
		return receiptOffline;
	}
	public void setReceiptOffline(ReceiptOffline receiptOffline) {
		this.receiptOffline = receiptOffline;
	}
	...
	public SettlePaymentDTO getSettlePaymentDTO() {
		return settlePaymentDTO;
	}
	public void setSettlePaymentDTO(SettlePaymentDTO settlePaymentDTO) {
		this.settlePaymentDTO = settlePaymentDTO;
	}
