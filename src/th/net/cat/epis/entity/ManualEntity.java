...
public class ManualEntity {
	...
	@Column(name="PAYMENT_ID") private Long paymenId;
	@Column(name="INVOICE_NO") private String invoiceNo;//account_no
	@Column(name="RECEIPT_NO_MANUAL") private String receiptNoManual;
	...
	@Column(name="CLEARING_SAP") private String clearingSap;
