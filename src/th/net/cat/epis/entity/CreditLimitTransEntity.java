...
public class CreditLimitTransEntity implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (contract != null ? !contract.equals(that.contract) : that.contract != null)
			return false;
		if (arRef != null ? !arRef.equals(that.arRef) : that.arRef != null)
			return false;
		if (payType != null ? !payType.equals(that.payType) : that.payType != null)
			return false;
		if (amountIncVat != null ? !amountIncVat.equals(that.amountIncVat) : that.amountIncVat != null)
			return false;
		if (payDate != null ? !payDate.equals(that.payDate) : that.payDate != null)
			return false;
		if (msisdn != null ? !msisdn.equals(that.msisdn) : that.msisdn != null)
			return false;
		...
		if (vatAmount != null ? !vatAmount.equals(that.vatAmount) : that.vatAmount != null)
			return false;
		if (amountExVat != null ? !amountExVat.equals(that.amountExVat) : that.amountExVat != null)
			return false;
		if (postDate != null ? !postDate.equals(that.postDate) : that.postDate != null)
			return false;
		if (accountNo != null ? !accountNo.equals(that.accountNo) : that.accountNo != null)
			return false;
		if (arInvdate != null ? !arInvdate.equals(that.arInvdate) : that.arInvdate != null)
			return false;
		if (arDuedate != null ? !arDuedate.equals(that.arDuedate) : that.arDuedate != null)
			return false;
