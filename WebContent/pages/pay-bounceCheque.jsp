...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <section class="container-fluid menu">
            ...
            <%@include file="menu.jsp"%>
                <form id="bounceChequeForm" method="post" class="form-horizontal" role="form">
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        ...
                                                        <div class="col-sm-6"><input class="form-control" id="cusName"></div>
                                                    </div>

                                                    <div class="col-sm-2">
                                                        <a id="search1" class="btn btn-primary" onclick="xxx()"><span class="glyphicon glyphicon-search"></span> ค้นหา</a>                                                        &nbsp;&nbsp;
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <ul id="navigatePanel" class="xx list-inline pull-right list-menu-set">
                    ...
                    <div class="row">
                        <div id="customerARPanel" class="x">
                            <div class="col-md-12 tab-modefile">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label class="control-label col-sm-2">กลุ่มผู้ใช้บริการ (กลุ่มลูกหนี้) :</label>
                                                                <div class="col-sm-2">
                                ...
                                <div class="tab-content">
                                        ...
                                        <table id="invoiceList" data-maintain-selected="true" class="table table-hover" data-toggle="table" data-detail-view="true"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="amountARin" data-sortable="true" data-align="center">จำนวนเงิน<br>ตามสกุลที่บันทึก</th>
                                                    <th data-field="rateChange" data-align="center" data-sortable="true">อัตรา<br>การแลกเปลี่ยน</th>
                                                    <th data-field="amountARout" data-sortable="true" data-align="center">จำนวนเงิน<br>สกุลในประเทศ</th>
                                    ...
                                    <div class="tab-pane" id="tab-history">
                                        <table id="historyList" data-toggle="table" data-classes="table table-hover table-striped">
                                            <thead>
                                                <tr>
                                                    <th runningFormatterdata-formatter="">#</th>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    &nbsp;&nbsp;&nbsp;รับชำระเงินล่วงหน้า</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2"><input id="deduct2" class="form-control text-right" disabled></div>
    ...
    <script type="text/javascript">
        ...
        function xxx() {
            var bounceChequeDTO = { "account": $("#account").val(), "cusName": $("#cusName").val() };
        ...
        function tablePayBounceCheque() {
            for (var i = 0; i < payBounceChequeDTOList.length; i++) {
                console.log(payBounceChequeDTOList[i].massage);
            }
        ...
        function calculate() {
            ...
            for (var rowid = 0; rowid < data.length; rowid++) {
                ...
                if (checked) {
                    ...
                    var amountChange = data[rowid]["amountARout"];
                    var amountChange2 = data[rowid]["amountARin"];

                    sumTotalCharge += amountChange;
                    sumTotalCharge2 += amountChange2;

                    var amountARout = calculateVatFromIncluded(data[rowid]["amountARout"]);
                    var amountARin = calculateVatFromIncluded(data[rowid]["amountARin"]);
            ...
            $('#sumBalance').val(sumBalance.toFixed(2));
            $('#sumBalance2').val(sumBalance2.toFixed(2));
            $('#sumVat').val(sumVat.toFixed(2));
            $('#sumVat2').val(sumVat2.toFixed(2));
            $('#sumTotalCharge').val(sumTotalCharge.toFixed(2));
            $('#sumTotalCharge2').val(sumTotalCharge2.toFixed(2));
        ...
        // 	$('#sumBalance').val("405714.14");
        // 	$('#sumBalance2').val("11682.24");
        // 	$('#sumVat').val("28399.99");
        // 	$('#sumVat2').val("817.76");
        // 	$('#sumTotalCharge').val("434114.13");
        // 	$('#sumTotalCharge2').val("12,500.00");
        // 	$('#xxxxx').val("");
        // 	$('#xxxxx').val("");
        ...
        function invoiceServiceFormatter(val, row, ind) {
            ...
            // loadPanel.finish(Mustache.render($('#template').html(), {
            //     "invoices": $.map(payBounceChequeDTO.subPayBounceChequeDTOList, function (o, i) {
            //         return {
            //             "productCode": o.productCode,
            //             "productName": o.productName,
            //             "subProductCode": o.subProductCode,
