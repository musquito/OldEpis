                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3"><input class="form-control" id="inputSearchMDN"></div>
                                    <div class="checkbox col-sm-3" ><label>&nbsp;&nbsp;&nbsp;<input type="checkbox" id="repeatOrder" > Repeat Order</label></div>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="tab_1">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">Order ID :</label>
                                            <div class="col-sm-2"><input class="form-control" disabled="disabled" id="inputCustomerOrderId"><input id="inputCustomerOrderIdRef" hidden><input id="agentAddressCode" hidden></div>
                                            <div class="col-sm-2">
                                            ...
                                            <%--<div class="checkbox col-sm-4" ><label>&nbsp;&nbsp;&nbsp;<input type="checkbox" id="repeatOrder" > Repeat Order</label></div>--%>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="control-label col-sm-10">ยอดเงินก่อนภาษีมูลค่าเพิ่ม  :</label>
                            <div class="col-sm-2">
...
// 	this.inputReceiptSegment = new Input("#inputReceiptSegment");
    ...
    function buttonSearchMDNClickEvent() {
        ...
        var hasOrderId = !view.inputSearchOrderId.isEmpty();
        var hasMDN = !view.inputSearchMDN.isEmpty();
