...
<script>
    var view = (function($){
        ...
        self.panelPayType = new FadePanel(self.buttonSetPayType, "#payType1", "#payType2");
    ...
    function buttonCreatePaymentAndPrintClickEvent() {
        ...
        if (cashRow.length == 1) { // For: Cash
            ...
            params["methods["+ methodIndex++ +"].amount"] = cashRow.find("td:eq(2) div").text().replace(/[,]/g, "");//cashRow[0].payAmount;
