...
<body>
	...
	<div style="position:absolute;top:64px;right:0;bottom:64px;left:0">
		<iframe name="page" style="width:100%;height:100%;border:0" src="Dashboard.jsp"></iframe>
	</div>
...
var fullname = '${epContext.userGivenName}'+ ' ' +'${epContext.userFamilyName}';
...
$.get("../service/officers/search/name", { "name": username }, function(res) {
	...
	document.getElementById("userInfo").innerHTML = '<span title="'+ user.code +' : ${epContext.branchCode} ${epContext.branchName} (Area: ${epContext.branchArea})">'+ fullname +" <span class='glyphicon glyphicon-exclamation-sign'></span> Role : ${epContext.roleName}</span>";
