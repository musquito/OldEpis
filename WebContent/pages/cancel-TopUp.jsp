		...
		<div class="row hide" id="panelCancelReceiptList1">
			<div class="col-md-12">
				<div class="table-responsive">
					<table data-toggle="table" id="tableReceiptList">
						<thead>
							<tr>
...
function buttonSearchReceiptClickEvent() {
	...
	var ss = inputSearchReceiptNo.val();
	     ...
	     if (!view.inputSearchServiceNo.isEmpty()||!view.inputSearchReceiptNo.isEmpty() ) { url = "../invPayTypeTopup.json";    params= { "serviceNo" : view.inputSearchServiceNo.val(),"receiptNo" : view.inputSearchReceiptNo.val(),  "payType": "TOPUP" } }
