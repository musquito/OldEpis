		...
		<form id="payServiceChargeForm" method="post" class="form-horizontal"
			...
			<div class="row">
				<div class="col-md-12 tab-modefile">
					<ol class="breadcrumb">
						<li><i>รับชำระค่าบริการหนี้ นอก TBOSS</i></li>
...
//                 }
                ...
                success: function (res) {
                    ...
                    if (res.data.length > 0) {
                        ...
                        for(var i = 0; i < res.data.length ; i++ ){
                        	...
                        	totalamount = totalamount + res.data[i].total_amount_ar;
        ...
        view.tab.invoiceDetailsTab.init(2, function () {
            ...
            $.get("../searchottbossdetails.json", { "inv": billNoSelected , "source" : "OTBOSS" }, function (res) {
