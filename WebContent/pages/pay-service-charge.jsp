...
<head>
    ...
    <script src="resources/js/bootstrap-datepicker.th.js" type="text/javascript" charset="UTF-8"></script>
...
<section class="container-fluid menu">
    ...
    <input type="hidden" name="customerType" id="customerType" value="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2"><input id="customerNo" class="form-control" ></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2"><input id="inputCollectionUnit" class="form-control" ></div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <select class="form-control" id="inputCustomerSegment" >
														...
														<option data-index="0" data-key="1" value="1" selected="selected">ธุรกิจทั่วไป</option>
														<option data-index="1" data-key="2" value="2">หน่วยงานรัฐ</option>
														<option data-index="2" data-key="3" value="3">บุคคลทั่วไป</option>
														<option data-index="3" data-key="4" value="4">Carrier/Operator/NON POTs</option>
														...
														<option data-index="7" data-key="8" value="8">ธุรกิจ กสท</option>
														<option data-index="8" data-key="9" value="9">สถานฑูต/องค์กรระหว่างประเทศ</option>
													</select>
                                                </div>
                                                <label class="control-label col-sm-2">เลขที่ e-GP</label>
                                                <div class="col-sm-2"><input id="egpNo" class="form-control" ></div>
                                                <label class="control-label col-sm-2">ยอดค้างชำระ (รวม VAT) :</label>
                                                <div class="col-sm-2"><input id="custInfoInputAccruedAmount" class="form-control" ></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2">Billing Group :</label>
                                                <div class="col-sm-2"><input id="billingGroup" class="form-control" ></div>
                                                <label class="control-label col-sm-2">เลขที่สัญญา (บช.1)</label>
                                                <div class="col-sm-2"><input id="egpContract" class="form-control" ></div>
                                                <label class="control-label col-sm-2">ยอดชำระล่วงหน้า :</label>
                                                <div class="col-sm-2"><input id="custInfoInputAdvancedAmount" class="form-control" ></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2">สถานะลูกค้า :</label>
                                                <div class="col-sm-2"><input id="custInfoInputStatus" class="form-control" value="ปกติ" readonly ></div>
                                                <label class="control-label col-sm-2"></label>
                                                <div class="col-sm-2"></div>
                                                <label class="control-label col-sm-2">สกุลเงิน :</label>
                                                <div class="col-sm-2"><input id="custInfoInputCurrencyCode" class="form-control" value="THB" readonly></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2 col-sm-offset-8">VAT Rate :</label>
                                                <div class="col-sm-2"><input id="custInfoInputVatRate" class="form-control" ></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div id="customerAddPanel" class="hide row">
            <div class="col-md-12 tab-modefile">
                <ul id="customerInfoAddTab" class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#tab_cus" aria-controls="tab_cus" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-user"></span> เพิ่มใบเสร็จ</a></li>
                    <li role="presentation"><a href="#sub_script" aria-controls="sub_script" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-list"></span> Subscription</a></li>
                </ul>
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="tab_cus">
                        <div class="panel panel-default panal-radius">
                            <div class="panel-body">
                                <div class="row">
                                 <form id="formCustomerAddPanel" action="#">
                                    <div class="col-md-12">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                            
                                      			<label class="control-label col-sm-2">เลขที่ใบแจ้ง :</label>
                                                <div class="col-sm-2"><input id="inputInvoiceNo" class="form-control" ></div>
                                                <label class="control-label col-sm-2">ยอดก่อนภาษี :</label>
                                                <div class="col-sm-6"><input id="inputCharge" class="form-control"></div>
                                                <input type="hidden" id=""><input type="hidden" id="acctCatLkp"><input type="hidden" id="catCustomerSegment">
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2">เงินส่วนลด :</label>
                                                <div class="col-sm-2"><input id="inputDiscount" class="form-control"></div>
                                                <label class="control-label col-sm-2">ภาษีมูลค่าเพิ่ม :</label>
                                                <div class="col-sm-2"><input id="inputVat" class="form-control" ></div>
                                                <label class="control-label col-sm-2">จำนวนเงินรวมภาษี :</label>
                                                <div class="col-sm-2"><input id="inputTotalCharge" class="form-control" ></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2">ยอดเงินปรับลด :</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control" id="inputTotalAdj" ></input>
                                                </div>
                                                <label class="control-label col-sm-2">จำนวนเงินคงค้าง</label>
                                                <div class="col-sm-2"><input id="inputBalanceDue" class="form-control" ></div>
                                                <label class="control-label col-sm-2">ยอดชำระ :</label>
                                                <div class="col-sm-2"><input id="inputBalanceDue2" class="form-control" ></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2">ภาษีหัก ณ ที่จ่าย :</label>
                                                <div class="col-sm-2"><input id="inputDeduct" class="form-control" ></div>
                                             
                                                <label class="control-label col-sm-2">รอบการใช้งานเริ่ม</label>
                                                <div class="col-sm-2"><input id="inputBillCycleFrom" class="form-control" data-date-format="dd/mm/yyyy" data-provide="datepicker" data-date-language="th-en"></div>
                                                <label class="control-label col-sm-2">รอบการใช้งานสิ้นสุด</label>
                                                <div class="col-sm-2"><input id="inputBillCycleTo" class="form-control" data-date-format="dd/mm/yyyy" data-provide="datepicker" data-date-language="th-en"></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2">วันจัดทำใบแจ้งค่าใช้บริการ</label>
                                                <div class="col-sm-2"><input id="inputIssueDt" class="form-control" data-date-format="dd/mm/yyyy" data-provide="datepicker" data-date-language="th-en" ></div>
                                                <label class="control-label col-sm-2">สถานะ</label>
                                                <div class="col-sm-2"><input id="inputStatus" class="form-control" value="ปกติ" readonly=""></div>
                                                <label class="control-label col-sm-2">วันครบกำหนด</label>
                                                <div class="col-sm-2"><input id="inputDueDt" class="form-control" data-date-format="dd/mm/yyyy" data-provide="datepicker" data-date-language="th-en"  ></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2 col-sm-offset-8">ระยะเวลาคงค้าง(วัน)</label>
                                                <div class="col-sm-2"><input id="inputAging" class="form-control" ></div>
                                            </div>
                                        </div>
                                    </div>
                                	</form>
                               ...
                               <div class="col-md-12">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <a id="btnAddInvoice" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span> เพิ่มใบเสร็จ</a> &nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    var view = (function($){
        ...
        self.button = new(function(){
            ...
            that.btnAddInvoice = new Button("#btnAddInvoice");
        ...
        self.input = new(function(){
            ...
            that.inputCharge = new Input("#inputCharge");
            that.inputDiscount = new Input("#inputDiscount");
            that.inputVat = new Input("#inputVat");
            that.inputTotalCharge = new Input("#inputTotalCharge");
            that.inputTotalAdj = new Input("#inputTotalAdj");
            that.inputBalanceDue = new Input("#inputBalanceDue");
            that.inputBalanceDue = new Input("#inputBalanceDue");
            that.inputDeduct = new Input("#inputDeduct");
...
// 	view.table.invoiceList.hideLoad();
    ...
    $(document).ready(function() {
        ...
        view.dialog.customerPanel.slideDown(500, function(){ view.dialog.navigatePanel.slideDown() });
        view.dialog.summaryPanel.show(1300);
        view.dialog.customerAddPanel.show();
        view.dialog.detailsPanel.show(900);
    ...
    function btnAddInvoiceClickEvent(){
    	...
    	data['accountNo'] = '';
    	data['aging']= parseFloat(view.input.inputAging.val());
    	data['amount'] = parseFloat(view.input.inputCharge.val());
    	data['balanceDue']= parseFloat(view.input.inputBalanceDue.val());
    	data['billCycle']= view.input.inputBillCycleFrom.val()+'-'+ view.input.inputBillCycleTo.val();
    	data['billRefNo'] = parseFloat(view.input.inputInvoiceNo.val());
    	data['charge']= parseFloat(view.input.inputCharge.val());
		//data['checked'] ='';
    	//data['currencyCode'] ='';
    	data['deduct']= parseFloat(view.input.inputDeduct.val());
    	data['discount']= parseFloat(view.input.inputDiscount.val());
    	data['dueDt']= view.input.inputDueDt.val();
		//data['invoiceDisplay'] = '';
    	data['invoiceNo']= parseFloat(view.input.inputInvoiceNo.val());
    	//data['invoiceVatDetails'] = {}; data['invoiceVatDetails'].push();
    	data['issueDt']= view.input.inputIssueDt.val();
		//data['rentalCharge'] = '';
    	data['status']= view.input.inputStatus.val();
		//data['subNoList'] = '';
		//data['taxTypeCode'] ='';
    	data['totalAdj']= parseFloat(view.input.inputTotalAdj.val());
    	data['totalCharge']= parseFloat(view.input.inputTotalCharge.val());
		data['vat']= parseFloat(view.input.inputVat.val());
    	data['vatRate'] = parseFloat(view.custInfoInputVatRate.val());
    	/* :
		accountNo:"1100644"
		aging:355
		amount:8296.77
		...
		totalAdj:0
		totalCharge:8877.54
		totalPaid:0//profile pay
		usageCharge:8296.77
		vat:580.77
		vatRate:7
		 */
		 view.table.invoiceList.rawDataList(data);
    	//view.table.subScriptionListTb.insert([checkBoxList,ba+valueHidden+msisdnSize, invoice.no, subScriptionNoList]);
    	view.table.invoiceList.rawData(view.table.invoiceList.rawDataList());
