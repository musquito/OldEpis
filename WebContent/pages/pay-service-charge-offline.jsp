...
<body>
	...
	<section class="container-fluid menu">
		...
		<form id="payServiceChargeForm" method="post" class="form-horizontal"
			...
			<ul id="navigatePanel"
				class=" list-inline pull-right list-menu-set">
										...
										<div class="col-md-12">
											<div class="form-horizontal">
												<div class="form-group">
													...
													<label class="control-label col-sm-2">เลขที่ใบแจ้ง
														:</label>
													<div class="col-sm-2">
													...
													<div class="col-sm-2">
														<input id="inputฺฺฺBa" class="form-control">
													</div>
												...
												<div class="form-group">
													<label class="control-label col-sm-2">ยอดเงินปรับลด
														:</label>
													<div class="col-sm-2">
													...
													<div class="col-sm-2">
														<input id="inputBalanceDue" class="form-control">
													</div>
												...
												<div class="form-group">
													...
													<label class="control-label col-sm-2">ระยะเวลาคงค้าง(วัน)</label>
													<div class="col-sm-2">
														<input id="inputAging" class="form-control">
													</div>
												</div>
...
<script type="text/javascript">
    ...
    var view = (function($){
        ...
        self.input = new(function(){
            ...
            that.inputVat = new NumberInput("#inputVat");
            that.inputTotalCharge = new NumberInput("#inputTotalCharge");
            that.inputTotalAdj = new NumberInput("#inputTotalAdj");
            that.inputBalanceDue = new NumberInput("#inputBalanceDue");
            ...
            that.inputฺฺฺBa = new Input("#inputฺฺฺBa");
            ...
            that.discount = new NumberInput("#inputDiscount");
...
//     	console.log("hasDueAmount : "+hasDueAmount);
    	...
    	params = {
       		 ...
       		 "inputฺฺฺBa":  view.input.inputฺฺฺBa.val(),
       		 "inputBeforVat":  view.input.inputBeforVat.val(),
       		 "inputDiscount": view.input.inputDiscount.val(),
       		 "inputVat": view.input.inputVat.val(),
       		 "inputTotalCharge": view.input.inputTotalCharge.val(),
       		 "inputTotalAdj" : view.input.inputTotalAdj.val(),
       		 "inputBalanceDue" : view.input.inputBalanceDue.val(),
