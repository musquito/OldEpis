...
<title>ประวัติรับชำระค่าบริการหนี้สูญ(TBOSS)</title>
		...
		<form id="payServiceChargeForm" method="post" class="form-horizontal"
			...
			<div class="row">
				<div class="col-md-12 tab-modefile">
					<ol class="breadcrumb">
						<li><i>ประวัติรับชำระค่าบริการหนี้ศูนย์ (TBOSS)</i></li>
					</ol>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<a id="search" class="btn btn-primary"><span
													class="glyphicon glyphicon-search"></span> ค้นหา</a> <a
													id="advanceSearch" class="btn btn-success"><span
										...
										<div class="col-md-12 tab-modefile">
											<ul id="addressTab" class="nav nav-tabs" role="tablist">
												...
												<li role="presentation" class="">
													<div class="checkbox">
														<label> &nbsp;&nbsp;<input
															id="changeReceiptAddress" type="checkbox"
															style="display: none">
														</label>
													</div>
												</li>
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.data.length > 0) {
                        ...
                        view.dialog.customerPanel.slideDown(500);
