...
<!-- 		                                            <button class="btn btn-success"  data-toggle="modal" data-target="#CustomerSearch"><span class="glyphicon glyphicon-zoom-in"></span> ค้นหาเพิ่มเติม</button></div> -->
            ...
            <div class="row hide" id="panelCancelReceiptList1">
	                    ...
	                    <div role="tabpanel" class="tab-pane active" id="tab-2-1">
	                        <table data-toggle="table" id="tableCancelReceiptList1" data-detail-view="true" data-detail-formatter="invoiceDetailsFormatter">
	                            <thead>
	                                <tr>
		...
		<div class="row hide" id="panelCancelReceiptList2">
			<div class="col-md-12 tab-modefile">
                    ...
                    <table id="tableCancelReceiptList2" data-toggle="table" data-detail-view="true" data-detail-formatter="invoiceDetailsFormatter">
                        <thead>
                            <tr>
                             <th data-align="center" data-formatter="runningFormatter">#</th>
                             <th data-field="no" data-align="center">เลขที่ใบเสร็จรับเงิน</th>
