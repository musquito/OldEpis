    ...
    <body>
        ...
        <section class="container-fluid menu">
			...
			<ul class="list-inline pull-right list-menu-set">
				<li><a href="pay-manual-service-1.jsp?new"><span class="glyphicon glyphicon glyphicon-arrow-left"></span> กลับไปหน้าการรับชำระ</a></li>
			</ul>
			<div class="row">
				<div class="col-md-12">
            ...
            <ul id="navigationPanel" class="list-inline pull-right list-menu-set">
                <li><a href="pay-manual-service-2.jsp" class="btn btn-link"><span class="glyphicon glyphicon-th-list"></span> สรุปรายการรับชำระ</a></li>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                            	<div class="form-group row">
                                        <label class="control-label col-sm-2">เลขที่อ้างอิงใบเสร็จ Manual :</label>
                                        <div class="col-sm-3"><input class="form-control" id="inputPayCashRefDoc" maxlength="62"></div>
                                    
                                        <label class="control-label col-sm-2">วันที่รับชำระ :</label>
                                        <div class="col-sm-3 input-group input-append date" data-date-format="dd/mm/yyyy" id="payDate" data-provide="datepicker">
                                            <input id="paymentDate" class="form-control" placeholder="dd/MM/yyyy">
                                            <span class="input-group-btn"><a class="btn btn-default"><span class="glyphicon glyphicon-calendar"></span></a></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2">สถานที่รับชำระ (BP):</label>
                                        <div class="col-sm-3"><!-- <input class="form-control" id="inputPayCashBP" maxlength="62"> -->
                                        <select id="inputPayCashBP" class="form-control select2">
										</select>
                                        </div>
                                    
                                        <label class="control-label col-sm-2">สถานที่รับชำระ (BA):</label>
                                        <div class="col-sm-3"><!-- <input class="form-control" id="inputPayCashBA" maxlength="18"> -->
                                        <select id="inputPayCashBA" class="form-control select2">
                                      
										</select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2">จำนวนเงินที่รับชำระ :</label>
                                        <div class="col-sm-3"><input id="paymentAmount" class="form-control text-right" onblur="changeAmount()" readonly=""></div>
                                    </div>
                            </div>
                        </div>
                    </div>
