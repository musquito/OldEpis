...
<script type="text/javascript">
	...
	//self.navigateAdjustAmountSearchList = new Panel("#navigateAdjustAmountSearchList");
	...
	self.panelAdjustDocument = new Panel("#panelAdjustDocument");
	...
	self.inputApvReasonType = new Listbox("#inputApvReasonType").init("../MasterData/getSpecificGroupData?group=ADJUST_AMOUNT_STATUS&keyGroup=02");
	self.inputRejectReasonType = new Listbox("#inputRejectReasonType").init("../MasterData/getSpecificGroupData?group=ADJUST_AMOUNT_STATUS&keyGroup=02");
...
function chkCurrencySymbol(str){
        ...
        $.get("../findProduct.json", { "no": row.billRefNo,"source":"IBACSS" }, function(res){
        	...
        	$.get("../findAdjustAmountDetailList.json", { "adjAmtId": row.adjAmtId}, function(resAdjustDetail){
	            ...
	            loadPanel.finish(Mustache.render($table.html(), { "invoices": $.map(res.data, function(o, i){
	                ...
	                return { "productCode": o.productCode, "productName": o.productName, "subProductCode": o.subProductCode, "subProductName": o.subProductName, "revTypeCode":o.revTypeCode , "revTypeName": o.revTypeName, "amount": view.utils.numberFormat(o.amount) , "billRefNo": o.billRefNo  , "approveAmount": invProductMap[index],"contrno":o.contrno,"adjustAmount":o.adjustAmount,"adjAmtDtlId":o.adjAmtDtlId}
	            }) }));
	...
	$('#selectApvAdjustAmountReasonModal').on('hide.bs.modal', function(e){
	   	 console.log("self.inputApvReasonType.val() >> "+self.inputApvReasonType.val());
	...
	function buttonApvAdjustAmountConfirmClickEvent(){
		...
		post("../approveAmountAdjustment.json", data, function(res){
			...
			if(res != null && res["statusCode"] == "0"){
				...
				for(var i = 0 ; i < adjustAmountEditList.length ; i++ ){
					adjustAmountEditList[i]["status"] = desc ;
				}
