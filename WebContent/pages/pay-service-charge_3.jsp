...
var view = (function($){
	...
	self.input = new(function(){
		...
		that.charge = new NumberInput("#inputCharge");
...
function submitPayment(receiptLang) {
    ...
    var receivedMoney = view.inputReceived.val(),balanceDue = view.input.balanceDue.val()
	...
	if (cashRow.length == 1) { // For: Cash
		...
		params["methods["+ methodIndex++ +"].amount"] = amount;//cashRow.find("td:eq(2) div").text().replace(/[,]/g, "");
