												...
												<div id="comboBox" class="form-group">
													...
													<div class="col-sm-4">
														<select class="form-control" id="selectPaymentType"
															...
															<option class="center">--- กรุณาเลือก ---</option>
											...
											<div class="form-horizontal">
												<div class="form-group">
													...
													<input type="hidden" id="customerType"><input
														type="hidden" id="acctCatLkp"> <input
														type="hidden" id="catCustomerSegment">
												</div>
												<div class="form-group">
										...
										<div class="col-md-12 tab-modefile">
											<ul id="addressTab" class="nav nav-tabs" role="tablist">
												...
												<li role="presentation" class="">
													<div class="checkbox">
														<label> &nbsp;&nbsp;<input
															id="changeReceiptAddress" type="checkbox" style="display:none">														</label>
													</div>
												</li>
												<li role="presentation" class="">
													<div class="checkbox" style="margin-left: 20px">
														<label> &nbsp;<input id="splitReceiptDocument"
															type="checkbox" value="true" style="display:none">
														</label>
													</div>
												</li>
												<li role="presentation" class="">
						...
						<div class="panel-body">
							<div class="form-horizontal">
								...
								<!-- <div class="form-group">
                                    ...
                                    -->
                                        <input type="checkbox" id="advancedCheckbox" name="advancedCheckbox"> &nbsp;&nbsp;&nbsp;รับชำระเงินล่วงหน้า
                                        </label>
                                        ...
                                        <div class="col-sm-2">
                                            <input id="discountAmount" class="form-control text-right" disabled>
                                        </div>
                                    </div> -->
								<div class="form-group">
									<%--<label class="control-label col-sm-2" >รอบการใช้งาน</label>
        ...
        function invoiceServiceFormatter(val, row, ind) {
            ...
            $.get("../findProductOTBOSS.json", { "accountNo": row.accountNo, "nobil": row.invoiceNo }, function (res) {
                loadPanel.finish(Mustache.render($('#template').html(), {
                    "invoices": $.map(res.data, function (o, i) {
