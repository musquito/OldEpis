                ...
                <div role="tabpanel" class="tab-pane active" id="tab-2-1">
                    <table id="agentTable" data-toggle="table" data-toolbar="#AgentToolbar" data-search="true" data-show-pagination-switch="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-show-export="true" data-pagination="true" data-height="400" data-cache="false">
                        ...
                        <tr>
                            ...
                            <th data-field="taxIdPos" data-align="center">ตำแห่นง Tax ID</th>
                            <th data-field="ref1Pos" data-align="center">ตำแหน่ง Ref No.1</th>
                            <th data-field="ref2Pos" data-align="center">ตำแหน่ง Ref No.2</th>
                            <th data-field="invoiceNoPos" data-align="center">ตำแหน่งเลขที่ใบแจ้งฯ</th>
                            <th data-field="dueDatePos" data-align="center">ตำแหน่ง Due Date</th>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="tab_1">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3"><input class="form-control" id="taxIdPos" placeholder="ตำแหน่งเริ่มต้น-ตำแหน่งสิ้นสุด (Ex: 1-10)"></div>
                                            <label class="control-label col-sm-2">ตำแหน่ง Ref No.1 :</label>
                                            <div class="col-sm-3"><input class="form-control" id="ref1Pos" placeholder="ตำแหน่งเริ่มต้น-ตำแหน่งสิ้นสุด (Ex: 1-10)"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">ตำแหน่งเลขที่ใบแจ้งค่าใช้บริการ :</label>
                                            <div class="col-sm-3"><input class="form-control" id="invoiceNoPos" placeholder="ตำแหน่งเริ่มต้น-ตำแหน่งสิ้นสุด (Ex: 1-10)"></div>
                                            <label class="control-label col-sm-2">ตำแหน่ง Ref No.2 :</label>
                                            <div class="col-sm-3"><input class="form-control" id="ref2Pos" placeholder="ตำแหน่งเริ่มต้น-ตำแหน่งสิ้นสุด (Ex: 1-10)"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-2">ตำแหน่ง Due Date :</label>
                                            <div class="col-sm-3"><input class="form-control" id="dueDatePos" placeholder="ตำแหน่งเริ่มต้น-ตำแหน่งสิ้นสุด (Ex: 1-10)"></div>
...
<script>
    ...
    $(document).on("click", "a#searchAgent", function() {
        ...
        if($('#agentCode').val() == '' || $('#agentName').val() == '' || $('#isPositive').val() == '' || $('#agentTaxId').val() == '' || $('#agentCompanyName').val() == '' || $('#taxIdPos').val() == '' /*|| $('#invoiceNoPos').val() == '' || $('#ref1Pos').val() == '' || $('#ref2Pos').val() == '' || $('#dueDatePos').val() == '' || $('#amountPos').val() == ''*/) {
            ...
            var dataSend={
                ...
                taxIdPos:$("#taxIdPos").val(),
                invoiceNoPos:$("#invoiceNoPos").val(),
                ref1Pos:$("#ref1Pos").val(),
                ref2Pos:$("#ref2Pos").val(),
                dueDatePos:$("#dueDatePos").val(),
    ...
    function findAgentDetailById(id) {
        $.get("../findAgentDetailById.json", { "id": id }, function(res) {
            ...
            $("#taxIdPos").val(res.taxIdPos);
            $("#invoiceNoPos").val(res.invoiceNoPos);
            $("#ref1Pos").val(res.ref1Pos);
            $("#ref2Pos").val(res.ref2Pos);
            $("#dueDatePos").val(res.dueDatePos);
